...
describe('SlugifyPipe', () => {
  ...
  it(`should slugify a string with default separator`, () => {
    expect(pipe.transform('this_-is__a__ test - string!')).toEqual(
      'this-is-a-test-string'
    );
  });

  it(`should slugify a string with specified separator`, () => {
    expect(pipe.transform('this_-is__a__ test - string!', '_')).toEqual(
  ...
  it(`should slugify a string with special characters`, () => {
    expect(
      pipe.transform(
        '^this:string~is!separated@with#many$special%characters%',
        '_'
      )
