...
describe('TruncatePipe', () => {
  ...
  it(`should truncate a string using specified length and default suffix`, () => {
    expect(pipe.transform('This is a test string!', 14)).toEqual(
      'This is a test...'
    );
  });
  ...
  it(`should truncate a string using specified length while preserving words`, () => {
    expect(pipe.transform('This is a test string!', 13, '..', true)).toEqual(
      'This is a test..'
    );
    expect(
      pipe.transform('This is a test string!', 15, undefined, true)
