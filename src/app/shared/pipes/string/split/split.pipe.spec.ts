...
describe('SplitPipe', () => {
  ...
  it(`should split a string using default delimiter`, () => {
    expect(pipe.transform('This is a string!')).toEqual([
      'This',
      'is',
      'a',
      'string!',
  ...
  it(`should split a string using default delimiter and limit`, () => {
    expect(pipe.transform('This is a string!', undefined, 3)).toEqual([
      'This',
      'is',
      'a',
    ]);
  ...
  it(`should split a string using specified delimiter`, () => {
    expect(pipe.transform('This-is-another string', '-')).toEqual([
      'This',
      'is',
      'another string',
    ]);
  ...
  it(`should split another string using specified delimiter and limit`, () => {
    expect(pipe.transform('_Yet_another_string_', '_', 4)).toEqual([
      '',
      'Yet',
      'another',
      'string',
  ...
  // it(`should be null safe`, () => {   // as argument is string type so can't send null as value
